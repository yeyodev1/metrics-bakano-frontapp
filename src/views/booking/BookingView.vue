...
const experts: BookingExpert[] = [
  ...
  { key: 'meta', name: 'Joel Jimenez', role: 'Especialista en Meta Ads', photo: 'https://res.cloudinary.com/dpuody0df/image/upload/v1781632482/bakano_team_photos/dbdnkmbtheowkagts6ut.jpg', initials: 'JJ', color: '#E91E8C', gradient: 'linear-gradient(135deg, #E91E8C, #FD79A8)', accentBg: 'rgba(233, 30, 140, 0.08)', accentBorder: 'rgba(233, 30, 140, 0.2)', shadowColor: 'rgba(233, 30, 140, 0.25)', topics: ['Anuncios en Facebook e Instagram', 'Estrategia y optimización de campañas', 'Creativos, copy y segmentación', 'Resultados y métricas de campañas'], url: 'https://api.leadconnectorhq.com/widget/booking/GNizdekhY5SQaYTPdKPP', warning: 'Solo Meta Ads', warningDesc: 'Si tu duda es sobre anuncios en Facebook o Instagram, estás en el lugar correcto. Otros temas serán redirigidos.', icon: 'fa-solid fa-chart-simple' },
